				...
				<div style="height: 70px; background: #59955C;">
					<table>
						<tr>
							...
							<td align='left'
								style="margin-bottom: 20px; font-size: 21pt; position: inline; color: white; font-weight: bolder">Pending		Permissions</td>
				...
				foreach($result as $openrow) {
					...
					print("<td width='2%' align='center'><input type='button'  style='width:80px' onclick='process_permission(this.value,\"$date\",\"$user\")' value='".$openrow["permission_id"]."'> </td>");
					print("<td width='18%' align='left'>".$user."</td>");
					print("<td width='8%' align='center'>".$date."</td>");
					print("<td id='$type' width='8%' align='center'>".$time."</td>");
					print("<td width='9%' align='center'>".$hrs." Hrs</td>");
					print("<td id='$day' width='30%' align='left'>".$reason."</td>");
					print("<td width='11%' align='center'>".date("d-m-Y H:m:s", strtotime($openrow["appliedtime"]))."</td>");
					print("</tr>");
				}
				print("</table>");
				...
				<div style="margin: 0px 0px 0px 0px" align="center">
					<table align="center" style="width: 400px;">
						<tr id="buttons" style="display: none">
							<td align="center">
							<input type="button"	style="width: 100px; height: 30px; font-size: 15pt; color: white; background-color: green; font-family: Tahoma"	onclick="grantPermission('Approved')" value="Approve" /></td>
							<td align="center"><input type="button"		style="width: 100px; height: 30px; font-size: 15pt; color: white; background-color: red; font-family: Tahoma"	onclick="grantPermission('Rejected')" value="Reject" /></td>
						</tr>
						<tr id="button1" style="display: none">
							<td id='col_1'	style="font-size: 15px; color: red; font-weight: bolder;"	align="center" colspan='2'></td>
						</tr>
					</table>
				</div>
				...
				<input type='hidden' value=''	id='p_user'>
				<input type='hidden' value=''	id='p_date'>
