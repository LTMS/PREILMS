...
<div style="height: 70px; background: #59955C;">
	<table>
		<tr>
			...
			<td align='left'
				style="margin-bottom: 20px; font-size: 21pt; position: inline; color: white; font-weight: bolder">	Time Sheet - MIS Report</td>
		...
		<tr class="tab_header_bg">
	 	<td align="center" >
			<input	type="text" id="date_from" placeholder="From Date"  style="width: 80px;height:23px;color: #006600; font-weight: bolder; font-size: 15px;"	
								onchange="javascript:timesheet_jobReport_MIS();" />&nbsp;&nbsp;
			  <input 	type="text" id="date_to" placeholder="To Date"  style="width: 80px;height:23px;color: #006600; font-weight: bolder; font-size: 15px;" 
			  					onchange="javascript:timesheet_jobReport_MIS();" />&nbsp;&nbsp;
<!--			<input type='button' value='Job Report'	style="height: 25px;width: 100px; color: #006600; font-weight: bolder; font-size: 15px;" 
					onclick="javascript:timesheet_jobReport_MIS();" />&nbsp;&nbsp;
	-->			
