...
<div
	...
	<table width="100%" border="0" align="left" cellpadding="2"
		...
		&nbsp; &nbsp;&nbsp;
				<select	id='getUser'		style="height: 20px; width: 150px; color: green; font-weight: bolder; font-size: 12px;"	onchange="team_activity_emp();">
			...
			<select id='getDept'	style="height: 22px; width: 180px; color: RED; font-weight: bolder; font-size: 12px;"	onchange="javascript:get_timesheet_Dept(this.value);">
			 ...
			 <select id='getTeam'	style="height: 22px; width: 180px; color: blue; font-weight: bolder; font-size: 12px;"
				...
				<input type='button' value='Job Report'	onclick="javascript:timesheet_team_job();"		style="display:none;width: 80px; color: #006600; font-weight: bold" />		&nbsp;&nbsp;
		...
		<tr style="display: none" id="errorrow">
			<td id="error" align="center" colspan="10"	style="color: red; width: 250px; font-size: 15px; font-weight: bolder;">
			</td>
		</tr>
	</table>
	<hr width="100%">
