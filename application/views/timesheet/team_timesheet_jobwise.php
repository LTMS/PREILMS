...
<div style="height: 70px; background: #59955C;">
	<table>
		<tr>
			...
			<td align='left'		style="margin-bottom: 20px; font-size: 21pt; position: inline; color: white; font-weight: bolder">Employees	Time Sheet</td>
...
<div
	...
	<table width="100%" border="0" align="left" cellpadding="2"
		...
		<input type='button' value='Job Report'	onclick="javascript:timesheet_jobReport();" style="height: 25px;width: 90px; color: #006600; font-weight: bold; font-size: 15px;" />
				&nbsp;&nbsp;
		<input type='button' value='Get All Jobs Summary'	onclick="overall_team_jobSummary();" style="height: 25px;width: 170px; color: #006600; font-weight: bold; font-size: 15px;background:#EEDDCC;" />
				&nbsp;&nbsp;
