<div
	...
	<table cellpadding="0" cellspacing="0" style="" border="1" width='100%'>

		<tr bgcolor="#D1D0CE"
			; style='height: 60; font-size: 14px; color: #2B547E; font-weight: bold;'>
			<td align='center' width='10%'>Employee Name</td>
			<td align='center' width='10%'>TWD <br>
			<font size='1px;'>(TotalDays-Holidays)</font>
			</td>
			<td align='center' width='5%'>TWH <br> <font size='2px;'>[Hrs]</font>
			</td>
			<td align='center' width='10%'>NWD <br>
			<font size='2px;'> (CL+SL+LOP+CO)</font>
			</td>

			<td align='center' width='10%'>EWD</td>
			<td align='center' width='10%'>EWH <br> <font size='2px;'>(-Permission)<br>
					[Hrs] </font>
			</td>



			<td align='center' width='10%'>TimeSheet <br> Updated</td>
			<td align='center' width='11%'>AWH <br>
			<font size='2px;'> (-Comp_Off) <br>[Hrs]</font>
			</td>
			<td align='center' width='8%'>Net OT</td>
			<td align='center' width='5%'>WOH <br>
			<font size='2px;'>[Days] </font>
			</td>
	...
	$profit=$new_actual-$new_exp;
		...
		print("</tr>");
		print("<tr>");
		print("<td style='font-size:10pt;font-weight:bold;color:#7e2217'> *WOH </td><td style='font-size:10pt;font-weight:bold;color:black'>- Worked On Holiday </td>");
		print("</tr>");
