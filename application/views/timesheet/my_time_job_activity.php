		...
		<tr class="tab_header_bg">
			...
			<input	type="text" id="date_from" placeholder="From Date"  style="width: 80px;height:23px;color: #006600; font-weight: bolder; font-size: 15px;"	
			  ...
			  <input 	type="text" id="date_to" placeholder="To Date"  style="width: 80px;height:23px;color: #006600; font-weight: bolder; font-size: 15px;" 
			  					onchange="get_my_time_activity();">&nbsp;&nbsp;
				<input type='button' value='Time Activity'	onclick="get_my_time_activity();" style="height: 25px;width: 100px; color: #006600; font-weight: bold; font-size: 15px;" />
				&nbsp;&nbsp;
				<input type='button' value='Job Activity'	onclick="get_my_job_activity();" style="height: 25px;width: 100px; color: #006600; font-weight: bold; font-size: 15px;" />
				&nbsp;&nbsp;
