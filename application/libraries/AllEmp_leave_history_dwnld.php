...
class AllEmp_leave_history_dwnld{

	public function Export($data){

		header("Content-type: application/vnd.ms-excel");
		header("Content-Disposition: attachment; filename=".date('dmY')."_All Employees Leave History.xls");
		...
		foreach($data as $openrow) {
			...
			print("<td  align='left'>".$openrow["User"]."</td>");
